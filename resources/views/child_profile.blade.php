          ...
          <div class="tm-top-header-inner">
            ...
            <nav class="tm-nav">
              <ul>
                ...
                <li><a href="#">Menu</a></li>
                <li><a href="http://127.0.0.1:8000/profil" class="active">Profile</a></li>
              </ul>
            </nav>   
          </div>           
        </div>    
...
<div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <h2 class="gold-text tm-welcome-header-2">BIODATA</h2>
          <p class="gray-text tm-welcome-description">Nama Lengkap &nbsp; &nbsp;: Mareta Rosa Anjellina </p>
          <p class="gray-text tm-welcome-description">Nama Panggilan &nbsp;: Mareta  </p>
          <p class="gray-text tm-welcome-description">TTL &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Tuban,06 Maret 2002 </p>
          <p class="gray-text tm-welcome-description">Jenis Kelamin &nbsp; &nbsp; &nbsp;   : Perempuan </p>
          <p class="gray-text tm-welcome-description">Jurusan/Prodi &nbsp; &nbsp; &nbsp;: TI/D-III Manajemen Informatika </p>
          <p class="gray-text tm-welcome-description">NIM     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: 2031710006 </p>
          <p class="gray-text tm-welcome-description">Alamat  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Dsn.Kedaton Ds.Leran Kulon Kec.Palang Kab.Tuban  </p>
          <p class="gray-text tm-welcome-description">Agama         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Islam </p>
